<template>
    <div class="bg-ffxiv min-h-[100vh] overflow-auto text-white font-body p-5">
        <div class="flex justify-center">
            <div class="w-1/2 bg-primary p-5 rounded-lg"><NuxtLink to="/">Home</NuxtLink></div>
        </div>
...
.bg-ffxiv {
    background-image: linear-gradient(rgba(var(--rgb-secondary), var(--bg-ffxiv-opacity)), rgba(var(--rgb-secondary), var(--bg-ffxiv-opacity))), url(/img/tiny/ffxiv.webp);
